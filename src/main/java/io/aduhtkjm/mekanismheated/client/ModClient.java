...
import io.aduhtkjm.mekanismheated.client.gui.machine.GuiPhaseChangeBlock;
...
import io.aduhtkjm.mekanismheated.client.gui.machine.GuiRetroentropicArray;
...
public class ModClient {
    ...
    public static void registerScreens(RegisterMenuScreensEvent event) {
        ...
        ClientRegistrationUtil.registerScreen(event, ModContainerTypes.RETROENTROPIC_ARRAY, GuiRetroentropicArray::new);
